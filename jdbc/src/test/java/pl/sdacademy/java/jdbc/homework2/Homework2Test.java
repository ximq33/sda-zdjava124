...
class Homework2Test {
    ...
    void shouldReturnActorsByBerFragment() {
        //WHEN
        final var actors = Homework2.getActors(Homework2.sqlSessionFactory(TestDbHelper.JDBC_URL), "berr");
    ...
    void shouldReturnActorsByCamerFragment() {
        //WHEN
        final var actors = Homework2.getActors(Homework2.sqlSessionFactory(TestDbHelper.JDBC_URL), "camer");
    ...
    void shouldReturnActorsFromAlienFilms() {
        //WHEN
        final var actors = Homework2.getActors(Homework2.sqlSessionFactory(TestDbHelper.JDBC_URL), "alien");
    ...
    void shouldReturnEmptyList(String query) {
        //WHEN
        final var films = Homework2.getActors(Homework2.sqlSessionFactory(TestDbHelper.JDBC_URL), query);
