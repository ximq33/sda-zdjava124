...
CREATE TABLE city (
    "ID"          INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 4080),
...
CONSTRAINT country_language_pk PRIMARY KEY ("CountryCode", "Language"),
CONSTRAINT contry_language_country_code_fk
    FOREIGN KEY ("CountryCode") REFERENCES country ("Code")
        ON UPDATE CASCADE ON DELETE CASCADE
);
